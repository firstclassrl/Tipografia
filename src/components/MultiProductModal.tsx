  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 w-full max-w-6xl h-full max-h-[90vh] flex flex-col rounded-2xl shadow-2xl">
          {/* Header */}
...
{existingOrder ? 'Modifica' : 'Nuovo'} Ordine - {printType.charAt(0).toUpperCase() + printType.slice(1)}
      ...
      {isProductModalOpen && currentProduct && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
          <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 w-full max-w-4xl h-full max-h-[90vh] flex flex-col rounded-2xl shadow-2xl">
            <div className="flex items-center justify-between p-6 border-b border-white/10">
